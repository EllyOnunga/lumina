...
export function IsFeatured() {
    ...
    return (
        <section className="py-24 container mx-auto px-4 overflow-hidden">
            <div className="bg-card/50 dark:bg-card/20 backdrop-blur-md border border-border/50 dark:border-white/5 rounded-3xl p-12 md:p-20 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-700">
                <div className="flex flex-col items-center text-center mb-20 space-y-6">
                    ...
                    <h2 className="text-5xl md:text-8xl font-black tracking-tighter uppercase italic leading-none animate-in fade-in slide-in-from-bottom-8 duration-1000 text-foreground">
